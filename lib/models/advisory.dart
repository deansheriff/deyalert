...
final demoAdvisories = <SecurityAdvisory>[
  SecurityAdvisory(
    id: '20000000-0000-4000-8000-000000000001',
    title: 'Sample media advisory for the Ikeja area',
    summary:
        'This demonstration shows how reviewed security coverage will appear separately from community reports.',
    ...
    sourceCount: 2,
    articleCount: 2,
    firstPublishedAt: DateTime.now().toUtc().subtract(const Duration(hours: 1)),
    lastUpdatedAt: DateTime.now().toUtc().subtract(const Duration(minutes: 20)),
    expiresAt: DateTime.now().toUtc().add(const Duration(days: 2)),
    distanceKm: 1.8,
    trendScore: 10,
    sources: [
      AdvisorySource(
        sourceName: 'Dey Alert demo source',
        title: 'Sample media advisory for the Ikeja area',
        url: 'https://example.com',
        publishedAt: DateTime.now().toUtc().subtract(const Duration(hours: 1)),
      ),
      AdvisorySource(
        sourceName: 'Dey Alert second demo source',
        title: 'Security update issued for Ikeja',
        url: 'https://example.com',
